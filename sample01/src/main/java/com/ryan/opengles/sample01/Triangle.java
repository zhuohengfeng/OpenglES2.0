...
import com.ryan.opengles.baseutils.ShaderUtil;
...
public class Triangle {
    ...
    int muMVPMatrixHandle;//总变换矩阵引用(在顶底着色器中)
    int maPositionHandle; //顶点位置属性引用(在顶底着色器中)
    int maColorHandle; //顶点颜色属性引用(在顶底着色器中)
